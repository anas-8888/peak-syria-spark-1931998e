-- Update create_order_with_items function to include shipping and discount info
DROP FUNCTION IF EXISTS public.create_order_with_items(numeric, text, text, text, text, jsonb);
...
CREATE OR REPLACE FUNCTION public.create_order_with_items(
  ...
  p_shipping_carrier_id uuid,
  p_shipping_region_id uuid,
