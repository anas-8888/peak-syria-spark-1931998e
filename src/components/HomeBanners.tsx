...
const HomeBanners = () => {
  ...
  return (
    <section className="py-12 space-y-8">
      ...
      {fullWidthBanners.map((banner) => (
        ...
        >
          ...
          <div className="relative h-full flex items-center justify-center text-center px-8">
            <div className="max-w-3xl space-y-6" style={{ color: banner.text_color }}>
      ...
      {/* Half Width Banners */}
      {halfWidthBanners.length > 0 && (
        <div className="grid md:grid-cols-2 gap-8">
          {halfWidthBanners.map((banner) => (
            <div
              key={banner.id}
            ...
            >
              ...
              <div className="relative h-full flex items-center justify-center text-center px-6">
                <div className="space-y-4" style={{ color: banner.text_color }}>
                  ...
                  {banner.link_url && (
                    <Link to={banner.link_url}>
                      <Button
                        size="lg"
                        variant="outline"
                        className="group-hover:scale-105 transition-transform border-2"
                        style={{
          ...
          {cardBanners.map((banner) => (
            ...
            >
              <div className="relative h-[320px] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-6 space-y-2" style={{ color: banner.text_color }}>
