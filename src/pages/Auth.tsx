    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-md mx-auto">
          <div className="bg-card p-8 rounded-lg shadow-sm border-2 border-primary/10">
            {/* Logo */}
            ...
            <Button 
              ...
              variant="outline" 
              size="lg" 
              className="w-full rounded-full border-2 hover:border-primary/50 transition-all duration-300"
            >
