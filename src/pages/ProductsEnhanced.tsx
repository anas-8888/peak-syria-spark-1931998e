...
const ProductsEnhanced = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Page Header */}
      <section className="relative bg-gradient-to-br from-secondary via-secondary to-secondary/80 py-20 text-secondary-foreground overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-4 animate-fade-in">Our Collection</h1>
          <p className="text-xl text-secondary-foreground/80 animate-slide-in-left">
